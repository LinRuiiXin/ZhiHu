 ...
 * */
public class QuestionInfoAnswerAdapter extends RecyclerView.Adapter {
    private Activity context;
    private List<RecommendViewBean> data;
    private final LayoutInflater inflater;
    private final String serverLocation;

    public QuestionInfoAnswerAdapter(Context context, List<RecommendViewBean> data) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == VIEW_ALL_TEXT) {
            viewHolder = new AllTextViewHolder(inflater.inflate(R.layout.answer_all_text_no_title, parent, false));
        } else if (viewType == VIEW_HAS_IMAGE) {
            viewHolder = new HasImageViewHolder(inflater.inflate(R.layout.anwser_has_image_no_title, parent, false));
        } else if (viewType == VIEW_HAS_VIDEO) {
            viewHolder = new HasVideoViewHolder(inflater.inflate(R.layout.anwser_has_video_no_title, parent, false));
        }
        return viewHolder;
    }
...
//                viewHolder.video.thumbImageView.setImage("http://p.qpic.cn/videoyun/0/2449_43b6f696980311e59ed467f22794e792_1/640");
    ...
    class AllTextViewHolder extends CustomViewHolder {
        ...
        public AllTextViewHolder(@NonNull View itemView) {
            super(itemView);
            portrait = itemView.findViewById(R.id.altnt_portrait);
            username = itemView.findViewById(R.id.altnt_username);
            introduction = itemView.findViewById(R.id.altnt_introduction);
            content = itemView.findViewById(R.id.altnt_content);
            support = itemView.findViewById(R.id.altnt_support);
            comments = itemView.findViewById(R.id.altnt_comments);
        }
    }
    ...
    class HasImageViewHolder extends CustomViewHolder {
        ...
        public HasImageViewHolder(@NonNull View itemView) {
            super(itemView);
            portrait = itemView.findViewById(R.id.ahint_portrait);
            username = itemView.findViewById(R.id.ahint_username);
            introduction = itemView.findViewById(R.id.ahint_introduction);
            content = itemView.findViewById(R.id.ahint_content);
            image = itemView.findViewById(R.id.ahint_image);
            support = itemView.findViewById(R.id.ahint_support);
            comments = itemView.findViewById(R.id.ahint_comments);
        }
    }
    ...
    class HasVideoViewHolder extends CustomViewHolder {
        ...
        public HasVideoViewHolder(@NonNull View itemView) {
            super(itemView);
            portrait = itemView.findViewById(R.id.ahvnt_portrait);
            username = itemView.findViewById(R.id.ahvnt_username);
            introduction = itemView.findViewById(R.id.ahvnt_introduction);
            video = itemView.findViewById(R.id.ahvnt_video);
            video.backButton.setVisibility(View.GONE);
            video.tinyBackImageView.setVisibility(View.GONE);
            content = itemView.findViewById(R.id.ahvnt_content);
            support = itemView.findViewById(R.id.ahvnt_support);
            comments = itemView.findViewById(R.id.ahvnt_comments);
        }
    }

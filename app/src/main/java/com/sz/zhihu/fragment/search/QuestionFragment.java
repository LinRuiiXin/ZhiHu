...
public class QuestionFragment extends SearchFragment {
    ...
    public QuestionFragment(Keyword keyword) {
        super(keyword);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if(view == null){
            view = inflater.inflate(R.layout.search_question_fragment,container,false);
            init();
        }
        return view;
    }
    ...
    private void init() {
        SmartRefreshLayout refreshLayout = view.findViewById(R.id.sqf_refresh_layout);
        refreshLayout.setOnRefreshListener(this);
        refreshLayout.setOnLoadMoreListener(this);
        refreshLayout.autoRefresh();
        RecyclerView content = view.findViewById(R.id.sqf_content);
    ...
    void loadMore(int limit, int size, Consumer<Boolean> isSuccess, Consumer<Integer> len) {
        String url = serverLocation + "/SearchService/Search/Question/" + keyword.getTitle() + "/" + limit + "/" + size;
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                activity.runOnUiThread(()->{
                    if(simpleDto.isSuccess()){
                        List<com.sz.zhihu.vo.Information> res = gson.fromJson(gson.toJson(simpleDto.getObject()),new TypeToken<List<com.sz.zhihu.vo.Information>>(){}.getType());
                        data.addAll(res);
